        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.userL),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("nomail"), closeSoftKeyboard());

        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.userL), withText("nomail"),
                        childAtPosition(
                                allOf(withId(R.id.mainLayout),
                                        childAtPosition(
                                                withId(android.R.id.content),
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.userL), withText("nomail"),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("nomail@gmail.com"));

        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.userL), withText("nomail@gmail.com"),
                        childAtPosition(
                                allOf(withId(R.id.mainLayout),
                                        childAtPosition(
                                                withId(android.R.id.content),
